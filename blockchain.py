...
class Blockchain():  
    difficulty = 4   #means 4 zeors in front of hash
...
def main():
    ...
    database = ['Hello','whatsup','hello','bye']
    ...
    # blockchain.chain[2].data = 'New'  # Here we have manually corrupted blockchain to test it is valid or not
